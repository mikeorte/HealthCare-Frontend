					...
					<form noValidate autoComplete="off" id="prescription-form">
						<FormControl className={classes.formControl} fullWidth>
							...
							<Typography className={classes.formError} component="p">
								{this.props.prescriptionNameError}
							</Typography>
						</FormControl>
						...
						<FormControl className={classes.formControl} fullWidth>
							...
							<Typography className={classes.formError} component="p">
								{this.props.prescriptionDoctorError}
							</Typography>
						</FormControl>
						...
						<FormControl className={classes.formControl} fullWidth>
							...
							/>
							<Typography className={classes.formError} component="p">
								{this.props.prescriptionDateError}
							</Typography>
						</FormControl>
						...
						<FormControl className={classes.formControl} fullWidth>
							...
							/>
							<Typography className={classes.formError} component="p">
								{this.props.prescriptionAmountError}
							</Typography>
						</FormControl>
						...
						<FormControl className={classes.formControl} fullWidth>
							...
							/>
							<Typography className={classes.formError} component="p">
								{this.props.prescriptionDirectionsError}
							</Typography>
						</FormControl>
